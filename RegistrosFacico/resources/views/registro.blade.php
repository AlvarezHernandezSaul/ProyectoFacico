...
<div class="linea"></div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between registro align-items-md-center">
        <p class="container fs-6 fw-bold text-center my-2 my-md-0"> REGISTRO DE SALAS DE COMPUTO </p>
...
<div class="col-12 text-center">
    <button type="button" class="btn text-light fs-4" style="background-color: #2d5135;" data-bs-toggle="modal" data-bs-target="#exampleModal">
        REGISTRARSE
      </button>
     </div> 
      <!-- Modal -->
